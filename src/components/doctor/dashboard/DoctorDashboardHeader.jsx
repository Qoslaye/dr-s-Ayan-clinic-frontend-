...
const DoctorDashboardHeader = ({ activeTab }) => {
  return (
      ...
      <div className="flex justify-between items-center px-8 py-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-3">
            <FaUserMd className="w-8 h-8 text-gray-600 dark:text-gray-300" />
            <div className="text-sm">
              <p className="font-medium text-gray-900 dark:text-white">Dr. Ayan Hussein</p>
              <p className="text-gray-500 dark:text-gray-400">General Physician</p>
            </div>
          </div>
        </div>
      </div>
